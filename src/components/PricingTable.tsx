    ...
    <section id="pricing" className="py-8 md:py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 max-w-3xl mx-auto">
          {/* Monthly Plan */}
          <div className="flex-1 bg-gradient-to-br from-[#1a85cc] to-[#cc9900] rounded-xl p-4 md:p-6 border-2 border-[#1a85cc]/40 hover:border-[#1a85cc]/80 transition-all duration-500 relative shadow-xl hover:shadow-[#1a85cc]/30 hover:transform hover:scale-[1.02]">
              ...
              {monthlyFeatures.map((feature, index) => (
                <div key={index} className="flex items-center space-x-4">
                  <div className="w-4 h-4 bg-white rounded-full flex items-center justify-center flex-shrink-0 shadow-lg">
                    <Check className="w-2.5 h-2.5 text-[#1a85cc]" strokeWidth={3} />
                  </div>
