        ...
        <div className="text-center mt-8">
          ...
          <div className="mb-6">
            <button
              ...
              className="bg-gradient-to-r from-[#00e676] to-[#21a1ff] text-[#15192c] px-8 md:px-10 py-4 rounded-2xl text-lg md:text-xl font-bold shadow-2xl hover:shadow-[#00e676]/25 hover:scale-110 transition-all duration-300 transform mb-4"
            >
              Assinar Agora 🚀
            </button>
